...
void CutieVolume::onServerInfoCallback(pa_context *c, const pa_server_info *i,
				       void *userdata)
{
...
void CutieVolume::onSubscribeCallback(pa_context *c,
...
void CutieVolume::onSinkInfoCallback(pa_context *c, const pa_sink_info *i,
...
void CutieVolume::setVolume(float volume)
{
	...
	pa_context_set_sink_volume_by_name(
		_context, _default_sink_name.toUtf8().constData(), &_cvolume,
		nullptr, this);
...
void CutieVolume::setMuted(bool muted)
{
	...
	pa_context_set_sink_mute_by_name(
		_context, _default_sink_name.toUtf8().constData(), m_muted,
		nullptr, this);

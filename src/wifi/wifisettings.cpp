	...
	: QObject(parent)
{
	...
	QDBusConnection::systemBus().connect(
		"org.freedesktop.NetworkManager",
		"/org/freedesktop/NetworkManager",
		"org.freedesktop.NetworkManager", "DeviceAdded", this,
		SLOT(onDeviceAdded(QDBusObjectPath)));

	QDBusConnection::systemBus().connect(
		"org.freedesktop.NetworkManager",
		"/org/freedesktop/NetworkManager",
		"org.freedesktop.NetworkManager", "DeviceRemoved", this,
...
void WifiSettings::onPropertiesChanged(QString iface,
...
void WifiSettings::onDevicePropertiesChanged(QString iface,
					     QMap<QString, QVariant> updated,
					     QStringList invalidated)
{
	Q_UNUSED(invalidated);
...
{
	QDBusInterface("org.freedesktop.NetworkManager", m_wlanPath.path(),
		       "org.freedesktop.NetworkManager.Device.Wireless",
		       QDBusConnection::systemBus())
...
void WifiSettings::setWirelessEnabled(bool wirelessEnabled)
{
	...
	arguments << "org.freedesktop.NetworkManager"
		  << "WirelessEnabled"
		  << QVariant::fromValue(QDBusVariant(m_wirelessEnabled));
